...
DELETE
FROM unicaen_avis_complem
WHERE avis_id IN (SELECT id
                  FROM unicaen_avis
...
DELETE
FROM unicaen_avis_type_valeur
WHERE avis_valeur_id IN (SELECT id
                         FROM unicaen_avis_valeur
                         WHERE code LIKE 'AVIS_ADMISSION_%');
DELETE
FROM unicaen_avis_type
WHERE code LIKE 'AVIS_ADMISSION_%';
DELETE
from unicaen_avis_valeur
where code LIKE 'AVIS_ADMISSION_%';
...
INSERT INTO public.unicaen_renderer_template (code, description, document_type, document_sujet, document_corps,
                                              document_css, namespace)
VALUES ('ADMISSION_NOTIFICATION_DECLARATION_DOSSIER_INCOMPLET',
