...
INSERT INTO public.unicaen_privilege_privilege (categorie_id, code, libelle, ordre)
VALUES ((SELECT id FROM unicaen_privilege_categorie WHERE code = 'hdr'), 'consultation-fiche', 'Consultation de la fiche d''identité de la HDR', 3025);
INSERT INTO public.unicaen_privilege_privilege (categorie_id, code, libelle, ordre)
...
INSERT INTO public.unicaen_privilege_privilege (categorie_id, code, libelle, ordre)
VALUES ((SELECT id FROM unicaen_privilege_categorie WHERE code = 'hdr'), 'donner-resultat', 'Attribution du résultat de la HDR suite à la soutenance', 3060);
...
<ul>
<li>tous les avis de soutenance de la HDR de VAR[Candidat#Denomination] ont été rendus ;</li>
<li>vous êtes garant de la HDR de VAR[Candidat#Denomination]. <br /><br /></li>
</ul>', null, 'Soutenance\Provider\Template', 'default');
INSERT INTO public.unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace, engine) VALUES ('SOUTENANCE_HDR_ENGAGEMENT_IMPARTIALITE', '<p>Texte associé à l''engagement d''impartialité</p>', 'texte', 'Engagement d''impartialité', '<p>En signant cet engagement d''impartialité, je, sous-signé <strong>VAR[SoutenanceMembre#Denomination]</strong>, atteste ne pas avoir de liens d''intérêt, qu''ils soient de nature professionnelle, familiale, personnelle ou patrimoniale avec le candidat ou son garant, ne pas avoir pris part aux travaux de la HDR et ne pas avoir de publication cosignée avec le  dans les cinq dernières années et ne pas avoir participé au comité de suivi de la HDR de VAR[Candidat#Denomination].</p><p>By signing, I certify that I have no personal or family connection with the HDR student or his/her HDR supervisor and that I have not taken part in the work of the HDR and not co-authored  publications with the HDR student for the last five years.<br /><br /></p>', null, 'Soutenance\Provider\Template', 'default');
...
<p>Une proposition de soutenance vient d\'être faite pour la HDR suivante :</p>
...
<ul>
<li>vous êtes un·e gestionnaire encadrant la HDR.</li>
</ul>', null, 'Soutenance\Provider\Template', 'default');
INSERT INTO public.unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace, engine) VALUES ('SOUTENANCE_HDR_VALIDATION_DEMANDE_ED', null, 'mail', 'Demande de validation d''une proposition de la soutenance HDR de VAR[Candidat#Denomination]', '<p>Bonjour,</p><p>Ceci est un mail envoyé automatiquement par l''application ESUP SyGAL.</p><p>Une proposition de soutenance vient d''être faite pour la HDR suivante :</p><table style="width: 473.433px;"><tbody><tr><td style="width: 547px;"><strong>Candidat·e</strong></td><td style="width: 467.433px;">VAR[Candidat#Denomination] (VAR[UniteRecherche#Sigle], VAR[Etablissement#Sigle])</td></tr></tbody></table><p>Pour examiner cette proposition et statuer sur celle-ci merci de vous rendre dans l''application ESUP SyGAL : VAR[Url#SoutenanceProposition].<br /><br />-- Justification ----------------------------------------------------------------------</p><p> Vous avez reçu ce mail car :</p><ul><li>l''unité de recherche de la HDR de VAR[Candidat#Denomination] ont validé la proposition de soutenance ;</li></ul>', null, 'Soutenance\Provider\Template', 'default');
...
<li>vous avez été désigné comme membre du jury pour la HDR de VAR[Candidat#Denomination].</li>
</ul>', null, 'Soutenance\Provider\Template', 'default');
INSERT INTO public.unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace, engine) VALUES ('SOUTENANCE_HDR_AVIS_FAVORABLE', null, 'mail', 'VAR[Acteur#Denomination] vient de rendre un avis favorable pour la HDR de VAR[Candidat#Denomination]', e'<p>Bonjour,</p>
<p>Le rapporteur VAR[Acteur#Denomination] vient de rendre un avis favorable pour la HDR de VAR[Candidat#Denomination] (VAR[UniteRecherche#Sigle], VAR[Etablissement#Sigle]).</p>
...
<li>un·e responsable de l\'unité de recherche accueillant la HDR de VAR[Candidat#Denomination]</li>
<li>garant de la HDR de VAR[Candidat#Denomination]</li>
</ul>
</li>
</ul>', null, 'Soutenance\Provider\Template', 'default');
...
INSERT INTO public.unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace, engine) VALUES ('SOUTENANCE_HDR_DEMANDE_ADRESSE_EXACTE', '<p>Courrier électronique envoyé au candidat ainsi qu''aux encadrants de la HDR afin de leur demander qu''ils renseignent l''adresse exacte de la soutenance</p>', 'mail', 'Renseignement de l''adresse exacte de la soutenance HDR ', e'<p>Bonjour,</p>
...
<p><strong>Keep in mind that your report must be uploaded before VAR[Soutenance#DateRetourRapport].</strong><br />After the deadline, you won\'t be able to upload your report.</p>
                                                                                                                                                                <p>Best regards,</p>
                                                                                                                                                                <p> </p>', null, 'Soutenance\Provider\Template', 'default');
INSERT INTO public.unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace, engine) VALUES ('SOUTENANCE_HDR_DEMANDE_RAPPORT_SOUTENANCE', '<p>Courrier électronique de demande du rapport de présoutenance à un·e rapporteur·trice</p>', 'mail', 'Demande de rapport de pré-soutenance pour la HDR de VAR[Candidat#Denomination]', e'<p><em>-- Version française -----------------------------------------------------------</em><br /><br />Bonjour,</p>
                                                                                                                                                                <p>Vous venez d\'être désigné comme rapporteur pour la HDR de VAR[Candidat#Denomination].</p>
...
INSERT INTO public.unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace, engine) VALUES ('SOUTENANCE_HDR_PROPOSITION_REFUS', '<p>Courrier électronique envoyé aux acteurs directs de la HDR lors du refus de la proposition</p>', 'mail', 'Votre proposition de soutenance HDR a été réfusée', e'<p>Bonjour,</p>
                                                                                                                                                                ...
                                                                                                                                                                <li>vous êtes un des acteurs directs de la HDR.<br /><br /></li>
...
INSERT INTO public.unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace, engine) VALUES ('SOUTENANCE_HDR_TRANSMETTRE_DOCUMENTS_GARANT', '<p>Courrier électronique envoyé au garant de la HDR pour transmission de documents avant soutenance</p>', 'mail', 'Transmission des documents pour la soutenance HDR de VAR[Candidat#Denomination]', e'<p>Bonjour,</p>
                                                                                                                                                                ...
                                                                                                                                                                <p>Document pour la soutenance :<br />- Procès verbal : VAR[Url#ProcesVerbal]<br />- Rapport de soutenance : VAR[Url#RapportSoutenance]<br />- Rapport technique (en cas de visio-conférence) : VAR[Url#RapportTechnique]</p>
                                                                                                                                                                <p><br />Bonne journée,<br />L\'équipe SyGAL</p>
<p> </p>', null, 'Soutenance\Provider\Template', 'default');
                                                                                                                                                             INSERT INTO public.unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace, engine) VALUES ('SOUTENANCE_HDR_SIGNATURE_ENGAGEMENT_IMPARTIALITE', '<p>Courrier électronique envoyé vers les gestionnaires HDR lors de la signature de l''engagement d''impartialité par un rapporteur</p>', 'mail', 'Signature de l''engagement d''impartialité de la HDR de VAR[Candidat#Denomination] par VAR[SoutenanceMembre#Denomination]', e'<p>Bonjour,</p>
<p><strong>VAR[SoutenanceMembre#Denomination]</strong> vient de signer l\'engagement d\'impartialité de la HDR de <strong>VAR[Candidat#Denomination]</strong>.</p>
...
<li>la proposition de soutenance vient d\'être validée par tous les acteurs directs et toutes les structures concernées ;</li>
                                                                                                                                                                <li>vous êtes soit :
                                                                                                                                                                <ul>
                                                                                                                                                                <li>un des acteurs directs de la HDR de VAR[Candidat#Denomination]</li>
                                                                                                                                                                <li>un·e responsable de l\'unité de recherche encadrant la HDR,</li>
...
<p><strong>VAR[SoutenanceMembre#Denomination]</strong> vient de refuser l\'engagement d\'impartialité de la HDR de <strong>VAR[Candidat#Denomination]</strong>.</p>
<p>-- Justification ----------------------------------------------------------------------</p>
<p>Vous avez reçu ce mail car :</p>
<ul>
...
<li>vous êtes :
<ul>
<li>soit un des acteurs directs de la HDR de VAR[Candidat#Denomination],</li>
<li>soit un gestionnaire HDR de l\'établissement d\'inscription du candidat.<br>            <br><br></li>
</ul>
</li>
</ul>', null, 'Soutenance\Provider\Template', 'default');
                                                                                                                                                             INSERT INTO public.unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace, engine) VALUES ('SOUTENANCE_HDR_AVIS_DEFAVORABLE', null, 'mail', 'VAR[Acteur#Denomination] vient de rendre un avis défavorable pour la HDR de VAR[Candidat#Denomination]', e'<p>Bonjour,</p>
<p>Le rapporteur VAR[Acteur#Denomination] vient de rendre un avis défavorable pour la HDR de VAR[Candidat#Denomination] (VAR[UniteRecherche#Sigle], VAR[Etablissement#Sigle]).<br>VAR[Acteur#Denomination] motive ce refus avec le justification suivante : VAR[Avis#Justification]</p>
<p> </p>
<p>Vous pouvez consulter le rapport de pré-soutenance en allant sur la page de gestion de la soutenance VAR[Url#SoutenanceProposition] ou en utilisant le lien suivant : VAR[Url#PrerapportSoutenance]</p>
<p>Vous avez reçu ce courrier électronique car :</p>
<ul>
...
INSERT INTO public.unicaen_renderer_template (code, description, document_type, document_sujet, document_corps, document_css, namespace, engine) VALUES ('SOUTENANCE_HDR_TOUS_AVIS_RENDUS', '<p>Courrier électronique vers les <em>aspects HDR</em>  indiquant que tous les avis ont été rendus</p>', 'mail', 'Tous les avis de soutenance de la HDR de VAR[Candidat#Denomination] ont été rendus.', e'<p>Bonjour,</p>
                                                                                                                                                                <p>Les rapporteurs de la HDR de VAR[Candidat#Denomination] ont rendu leur rapport de pré-soutenance.</p>
