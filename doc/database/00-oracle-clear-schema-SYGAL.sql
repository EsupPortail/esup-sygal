...
ALTER TABLE SYGAL.VALIDITE_FICHIER drop CONSTRAINT CONFORMITE_FICHIER_FFK;
...
ALTER TABLE SYGAL.FICHIER drop CONSTRAINT FICHIER_NATURE_FICHIER_ID_FK;
...
ALTER TABLE SYGAL.FICHIER drop CONSTRAINT FICHIER_THESE_FK;
...
ALTER TABLE SYGAL.IMPORT_OBSERV_RESULT drop CONSTRAINT IMPORT_OBSERV_RESULT__IO_FK;
...
ALTER TABLE SYGAL.INFORMATION_FICHIER drop CONSTRAINT INFORMATION_FICHIER_PK;
...
ALTER TABLE SYGAL.VALIDITE_FICHIER drop CONSTRAINT CONFORMITE_FICHIER_PK;
...
ALTER TABLE SYGAL.FICHIER drop CONSTRAINT FICHIER_PK;
...
DROP TABLE SYGAL.INFORMATION_FICHIER PURGE;
