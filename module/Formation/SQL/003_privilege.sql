INSERT INTO CATEGORIE_PRIVILEGE (ID, CODE, LIBELLE, ORDRE) VALUES (nextval('categorie_privilege_id_seq'), 'formation', 'Module de formation', 3000);
...
INSERT INTO CATEGORIE_PRIVILEGE (ID, CODE, LIBELLE, ORDRE) VALUES (nextval('categorie_privilege_id_seq'), 'formation_module', 'Gestion des modules de formations', 3100);
...
INSERT INTO PRIVILEGE (ID, CATEGORIE_ID, CODE, LIBELLE, ORDRE) VALUES (nextval('privilege_id_seq'), currval('categorie_privilege_id_seq'), 'catalogue', 'Accéder au catalogue des formations', 7);
...
INSERT INTO CATEGORIE_PRIVILEGE (ID, CODE, LIBELLE, ORDRE) VALUES (nextval('categorie_privilege_id_seq'), 'formation_seance', 'Gestion des séances de formations', 3300);
...
INSERT INTO CATEGORIE_PRIVILEGE (ID, CODE, LIBELLE, ORDRE) VALUES (nextval('categorie_privilege_id_seq'), 'formation_inscription', 'Gestion des inscriptions aux formations', 3400);
...
INSERT INTO CATEGORIE_PRIVILEGE (ID, CODE, LIBELLE, ORDRE) VALUES (nextval('categorie_privilege_id_seq'), 'formation_enquete', 'Gestion de l''enquête', 3500);
