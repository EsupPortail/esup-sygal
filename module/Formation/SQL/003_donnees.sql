...
INSERT INTO role (code, libelle, source_code, source_id, role_id, is_default, ldap_filter, attrib_auto, these_dep, type_structure_dependant_id, ordre_affichage)
VALUES ('FORMATEUR', 'Formateur·trice', 'SYGAL::FORMATEUR', 1, 'Formateur·trice', false, null, false, false, 1, null, 'formation_aab');
INSERT INTO role (code, libelle, source_code, source_id, role_id, is_default, ldap_filter, attrib_auto, these_dep, type_structure_dependant_id, ordre_affichage)
VALUES ('GEST_FORMATION', 'Gestionnaire de formation', 'SYGAL::GEST_FORMATION', 1, 'Gestionnaire de formation', false, null, false, false, 1, null, 'formation_aaa');
