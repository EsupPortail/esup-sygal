...
class ActionDiffusionCultureScientifiqueFieldset extends Fieldset implements InputFilterProviderInterface
{
    public function __construct()
    {
        parent::__construct('actionDiffusionCultureScientifique');

        $this->setHydrator(new ActionDiffusionCultureScientifiqueHydrator(false));
        $this->setObject(new ActionDiffusionCultureScientifique());
    }
