...
class RapportActivitePrivileges extends Privileges
{
    ...
    const RAPPORT_ACTIVITE_CONSULTER_TOUT = 'rapport-activite-consulter-tout';
    const RAPPORT_ACTIVITE_CONSULTER_SIEN = 'rapport-activite-consulter-sien';
    const RAPPORT_ACTIVITE_AJOUTER_TOUT = 'rapport-activite-ajouter-tout';
    const RAPPORT_ACTIVITE_AJOUTER_SIEN = 'rapport-activite-ajouter-sien';
    const RAPPORT_ACTIVITE_MODIFIER_TOUT = 'rapport-activite-modifier-tout';
    const RAPPORT_ACTIVITE_MODIFIER_SIEN = 'rapport-activite-modifier-sien';
    ...
    const RAPPORT_ACTIVITE_GENERER_TOUT = 'rapport-activite-generer-tout';
    const RAPPORT_ACTIVITE_GENERER_SIEN = 'rapport-activite-generer-sien';
