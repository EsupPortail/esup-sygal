...
class OldRapportActiviteForm extends Form implements InputFilterProviderInterface
{
    ...
    protected array $estFinContratValueOptions = [];
    ...
    {
        $this->estFinContratValueOptions[] = [
    ...
    {
        /** @var Radio $esFinContratRadio */
        $esFinContratRadio = $this->get('estFinContrat');
        $esFinContratRadio->setValueOptions($this->estFinContratValueOptions);
    }
