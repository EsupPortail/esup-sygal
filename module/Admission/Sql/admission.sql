...
-- Suppression des données concernant les templates et macro de Renderer
DELETE
...
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#INE', '<p>Retourne le numéro INE de l''étudiant</p>', 'admissionEtudiant',
        'getINE');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#DenominationEtudiant', '<p>Retourne la dénomination de l''étudiant</p>', 'admissionEtudiant',
        'getDenominationEtudiant');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#DateNaissance', '<p>Retourne la date de naissance formatée de l''étudiant</p>', 'admissionEtudiant',
        'getDateNaissanceFormat');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#VilleNaissance', '<p>Retourne la ville de naissance de l''étudiant</p>', 'admissionEtudiant',
        'getVilleNaissance');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#PaysNaissance', '<p>Retourne le pays de naissance de l''étudiant</p>', 'admissionEtudiant',
        'getPaysNaissanceLibelle');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#Nationalite', '<p>Retourne la nationalité de l''étudiant</p>', 'admissionEtudiant',
        'getNationaliteLibelle');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#Adresse', '<p>Retourne l''adresse de l''étudiant</p>', 'admissionEtudiant', 'getAdresseLigne3Bvoie');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#CodePostal', '<p>Retourne le code postal de l''adresse de l''étudiant</p>', 'admissionEtudiant',
        'getAdresseCodePostal');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#VilleEtudiant', '<p>Retourne la ville de l''étudiant</p>', 'admissionEtudiant',
        'getAdresseCodeCommune');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#NumeroTelephone', '<p>Retourne le numéro de téléphone de l''étudiant</p>', 'admissionEtudiant',
        'getNumeroTelephone1');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#MailEtudiant', '<p>Retourne le mail de l''étudiant</p>', 'admissionEtudiant', 'getCourriel');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#SituationHandicap', '<p>Retourne la situation de l''handicap de l''étudiant</p>',
        'admissionEtudiant', 'getSituationHandicapLibelle');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#NiveauEtude', '<p>Retourne le niveau d''étude de l''étudiant</p>', 'admissionEtudiant',
        'getNiveauEtudeInformations');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#InfosDiplome', '<p>Retourne les informations concernant le diplôme de l''étudiant</p>',
        'admissionEtudiant', 'getDiplomeIntituleInformations');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#SpecialiteDoctorat', '<p>Retourne la spécialité du doctorat choisie par l''étudiant</p>',
        'admissionInscription', 'getSpecialiteDoctoratLibelle');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#EcoleDoctorale', '<p>Retourne l''école doctorale choisie pour le doctorat de l''étudiant</p>',
        'admissionInscription', 'getEcoleDoctoraleLibelle');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#UniteRecherche', '<p>Retourne l''unité de recherche choisie pour le doctorat de l''étudiant</p>',
        'admissionInscription', 'getUniteRechercheLibelle');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#DenominationDirecteurThese', '<p>Retourne la dénomination du directeur de thèse de l''étudiant</p>',
        'admissionInscription', 'getDenominationDirecteurThese');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#TitreThese', '<p>Retourne le titre provisoire de la thèse de l''étudiant</p>',
        'admissionInscription', 'getTitreThese');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#ConfidentialiteSouhaitee', '<p>Retourne la confidentialité voulue pour la thèse de l''étudiant</p>',
        'admissionInscription', 'getConfidentialiteSouhaiteeLibelle');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#CotutelleEnvisagee', '<p>Retourne si une cotutelle est envisagée pour la thèse de l''étudiant</p>',
        'admissionInscription', 'getCotutelleEnvisageeLibelle');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#CoDirectionDemandee', '<p>Retourne si une codirection est demandée pour la thèse de l''étudiant</p>',
        'admissionInscription', 'getCoDirectionDemandeeLibelle');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#CoEncadrementEnvisage',
        '<p>Retourne si un co-encadrement est envisagé pour la thèse de l''étudiant</p>', 'admissionInscription',
        'getCoEncadrementLibelle');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#ContratDoctoral',
...
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#DetailContratDoctoral',
        '<p>Retourne si les détails du contrat doctoral pour la thèse de l''étudiant</p>', 'admissionFinancement',
        'getDetailContratDoctoral');
INSERT INTO unicaen_renderer_macro (code, description, variable_name, methode_name)
VALUES ('Admission#Operations', '<p>Retourne les opérations accordées au dossier d''admission de l''étudiant</p>',
...
INSERT INTO unicaen_renderer_template (code, description, document_type, document_sujet, document_corps,
                                       document_css, namespace)
VALUES ('ADMISSION_RECAPITULATIF',
        '', 'pdf',
...
<td style="width: 285.5px;">VAR[Admission#INE]</td>
<td style="width: 145px;"><strong> </strong></td>
<td style="width: 303px;"> </td>
</tr>
<tr>
<td style="width: 163.5px;"><strong>Étudiant :</strong></td>
<td style="width: 285.5px;">VAR[Admission#DenominationEtudiant]</td>
<td style="width: 145px;"><strong>Date de naissance :</strong></td>
<td style="width: 303px;">VAR[Admission#DateNaissance]</td>
</tr>
<tr>
<td style="width: 163.5px;"><strong>Ville de naissance :</strong></td>
<td style="width: 285.5px;">VAR[Admission#VilleNaissance]</td>
<td style="width: 145px;"><strong>Pays de naissance :</strong></td>
<td style="width: 303px;">VAR[Admission#PaysNaissance]</td>
</tr>
<tr>
<td style="width: 163.5px;"><strong>Nationalité :</strong></td>
<td style="width: 285.5px;">VAR[Admission#Nationalite]</td>
<td style="width: 145px;"><strong>Adresse :</strong></td>
<td style="width: 303px;">VAR[Admission#Adresse]</td>
</tr>
<tr>
<td style="width: 163.5px;"><strong>Code postal :</strong></td>
<td style="width: 285.5px;">VAR[Admission#CodePostal]</td>
<td style="width: 145px;"><strong>Ville :</strong></td>
<td style="width: 303px;">VAR[Admission#VilleEtudiant]</td>
</tr>
<tr>
<td style="width: 163.5px;"><strong>Numéro de téléphone :</strong></td>
<td style="width: 285.5px;">VAR[Admission#NumeroTelephone]</td>
<td style="width: 145px;"><strong>Mail :</strong></td>
<td style="width: 303px;">VAR[Admission#MailEtudiant]</td>
</tr>
</tbody>
</table>
<p>Etes-vous en situation de handicap ? VAR[Admission#SituationHandicap]</p>
<h3>Niveau permettant l''accès au doctorat</h3>
<p>VAR[Admission#NiveauEtude] </p>
<p>VAR[Admission#InfosDiplome]</p>
<h2>Inscription </h2>
<h3>Informations concernant son inscription demandée</h3>
<ul>
<li><strong>Spécialité d''inscription :</strong> VAR[Admission#SpecialiteDoctorat]</li>
<li><strong>Composante de rattachement : </strong></li>
<li><strong>École Doctorale :</strong> VAR[Admission#EcoleDoctorale]</li>
<li><strong>Unité de recherche :</strong> VAR[Admission#UniteRecherche]</li>
<li><strong>Directeur(-trice) de thèse :</strong> VAR[Admission#DenominationDirecteurThese]</li>
<li><strong>Titre provisoire de la thèse :</strong> VAR[Admission#TitreThese]</li>
</ul>
<h3>Spéciﬁcités envisagées concernant son inscription</h3>
<ul>
<li><strong>Conﬁdentialité souhaitée :</strong> VAR[Admission#ConfidentialiteSouhaitee]</li>
<li><strong>Cotutelle envisagée :</strong> VAR[Admission#CotutelleEnvisagee]</li>
<li><strong>Codirection demandée :</strong> VAR[Admission#CoDirectionDemandee]</li>
<li><strong>Co-encadrement envisagé :</strong> VAR[Admission#CoEncadrementEnvisage]</li>
</ul>
<h2>Financement</h2>
<p>Avez-vous un contrat doctoral ? VAR[Admission#ContratDoctoral]</p>
<p>Si oui, détails du contrat doctoral : VAR[Admission#DetailContratDoctoral]</p>
...
<p> </p>
<p> </p>
<p>Fait à ____________________, le ________________,</p><p>Signature de M. Lamri ADOUI, le Président de l''Université de Caen Normandie</p>',
        'table { border-collapse: collapse;  width: 100%;  } th, td { border: 1px solid #000; padding: 8px;  }',
