...
class PropositionTheseSearchService extends SearchService
{
    ...
    {
        $qb = $this->propositionTheseService->getRepository()->createQueryBuilder('proposition');
        $qb
...
//            ->addSelect('acteur')->leftJoin('membre.acteur', 'acteur') // n'existe plus
    ...
    public function init()
    {
        ...
        $etatFilter
            ->setDataProvider(fn() => $this->propositionTheseService->findPropositionEtats())
