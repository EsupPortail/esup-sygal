...
/**
 * @property \Acteur\Entity\Db\ActeurThese|\Acteur\Entity\Db\ActeurHDR $object
 */
abstract class AbstractActeurFieldset extends Fieldset implements InputFilterProviderInterface
{
    use QualiteServiceAwareTrait;

    protected string $urlIndividu;
    protected string $urlEtablissement;
    protected array $unitesRecherches;
