...
class ActeurHDRFieldsetFactory
{
    /**
     * @throws \Psr\Container\NotFoundExceptionInterface
     * @throws \Psr\Container\ContainerExceptionInterface
     */
    public function __invoke(ContainerInterface $container) : ActeurHDRFieldset
    {
        $fieldset = new ActeurHDRFieldset();
        ...
        /** @var ActeurHDRHydrator $hydrator */
        $hydrator = $container->get('HydratorManager')->get(ActeurHDRHydrator::class);
