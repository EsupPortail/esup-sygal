...
namespace Fichier\Validator;

use Application\Command\ShellCommandRunner;
use Fichier\Command\TestArchivabiliteShellCommandResult;
use Fichier\Command\TestArchivabiliteShellCommand;
...
class FichierCinesValidator extends AbstractValidator
{
    ...
    /**
     * @var \Fichier\Command\TestArchivabiliteShellCommandResult
     */
