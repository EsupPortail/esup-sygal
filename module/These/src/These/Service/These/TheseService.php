...
class TheseService extends BaseService //implements ListenerAggregateInterface
{
    ...
    public function fetchInformationsPageDeCouverture(These $these) : PdcData
    {
        ...
        if ($these->getDoctorant()) {
            $pdcData->setDoctorant(strtoupper($these->getDoctorant()->getIndividu()->getNomComplet(false, true, false, true)));
        }
        ...
        foreach ($acteursEnCouverture as $acteur) {
            ...
            $acteurData->setDenomination(strtoupper($acteur->getIndividu()->getNomComplet(true, false, false, true)));
        ...
        foreach ($directeurs as $directeur) {
            $current = strtoupper($directeur->getIndividu()->getNomComplet(false, false, false, true));
