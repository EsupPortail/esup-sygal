...
use These\Controller\Factory\TheseConsoleControllerFactory;
...
use These\Form\Factory\AttestationHydratorFactory;
use These\Form\Factory\AttestationTheseFormFactory;
use These\Form\Factory\DiffusionHydratorFactory;
use These\Form\Factory\DiffusionTheseFormFactory;
use These\Form\Factory\MetadonneeTheseFormFactory;
...
use These\View\Helper\Url\UrlTheseHelperFactory;
    ...
    'bjyauthorize' => [
        ...
        'guards' => [
            PrivilegeController::class => [
                ...
                [
                    'controller' => TheseObserverController::class,
                    'action' => [
...
//                            ],
                            ...
                            'depot' => [
                                ...
                                'resource' => PrivilegeController::getResourceId(TheseController::class, 'roadmap'),
                                'pages' => [
                                    // DEPTH = 3
                                    'roadmap' => [
                                    ...
                                    'points-de-vigilance' => [
                                        ...
                                        'resource' => PrivilegeController::getResourceId(TheseController::class, 'modifier-rdv-bu'),
                                        'etape' => null,
                                        'visible' => TheseAssertion::class,
                                    ],
                                    'depot-divers' => [
                                        ...
                                        'icon' => 'fas fa-copy',
                                        'resource' => PrivilegeController::getResourceId(TheseController::class, 'detail-fichiers'),
                                    ...
                                    'validation-page-de-couverture' => [
                                        ...
                                        'icon' => 'fas fa-image',
                                        'resource' => PrivilegeController::getResourceId(TheseController::class, 'validation-page-de-couverture'),
                                        //'etape' => WfEtape::CODE_DEPOT_VERSION_ORIGINALE,
                                        //'visible' => TheseAssertion::class,
                                    ],
                                    'depot' => [
                                    ...
                                    'signalement' => [
                                        ...
                                        'resource' => PrivilegeController::getResourceId(TheseController::class, 'detail-description'),
                                    ...
                                    'archivage' => [
                                        ...
                                        'resource' => PrivilegeController::getResourceId(TheseController::class, 'detail-archivage'),
                                    ...
                                    'rdv-bu' => [
                                        ...
                                        'resource' => PrivilegeController::getResourceId(TheseController::class, 'detail-rdv-bu'),
                                    ...
                                    'validation-these-corrigee' => [
                                        ...
                                        'icon' => 'fas fa-calendar',
                                        'resource' => PrivilegeController::getResourceId(TheseController::class, 'validation-these-corrigee'),
                                    ...
                                    'modifier-description' => [
                                        ...
                                        //'resource' => PrivilegeController::getResourceId(TheseController::class, 'modifier-description'),
                                        'visible' => false,
                                    ],
                                    'modifier-diffusion' => [
                                        ...
                                        //'resource' => PrivilegeController::getResourceId(TheseController::class, 'modifier-diffusion'),
                                        'visible' => false,
                                    ],
                                    'remise-version-papier-corrigee' => [
                                        ...
                                        'icon' => 'fas fa-book',
                                        'resource' => PrivilegeController::getResourceId(TheseController::class, 'depot-papier-final'),
    ...
    'controllers' => [
        ...
        'factories' => [
            ...
            TheseObserverController::class => TheseObserverControllerFactory::class,
        ],
        'aliases' => [
