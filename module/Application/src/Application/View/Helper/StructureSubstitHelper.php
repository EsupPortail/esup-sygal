...
class StructureSubstitHelper extends AbstractHelper {
     ...
     * @return string
     */
    public function structureSource(StructureConcreteInterface $structurestructureConcrete)
    {
        ...
        $texte .=           '<img class="current" style="max-width: 125px; max-height: 125px; border: 1px solid black; background-color: white;" src="data:image/png;base64,' . base64_encode($structurestructureConcrete->getLogoContent()) .'"/>';
