    ...
    public function assertAsBoolean($privilege)
    {
        ...
        //--------------------------------------------------------------------------------------
            ...
            if ($this->isRoleDoctorantSelected() /* test 1 */ && 
                ! $this->isUtilisateurEstAuteurDeLaThese() /* test 15 */) {
        ...
        //--------------------------------------------------------------------------------------
            ...
            if (! $this->isInfosBuSaisies() /* test 13 */) {
        ...
        //--------------------------------------------------------------------------------------
            ...
            if (! $this->isUtilisateurExisteParmiValidateursAttendus() /* test 16 */) {
                return false;
            }
            /* line 37 */
        ...
        //--------------------------------------------------------------------------------------
            ...
            if (! $this->isUtilisateurExisteParmiValidateursAyantValide() /* test 17 */) {
                return false;
            }
            /* line 39 */
