...
--
alter table ecole_doct add substit_update_enabled bool default true not null;
comment on column ecole_doct.substit_update_enabled is 'Indique si ce substituant (le cas échéant) peut être mis à jour à partir des attributs des substitués';
