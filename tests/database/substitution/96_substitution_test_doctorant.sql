...
as
$$begin
    alter table pre_doctorant disable trigger substit_trigger_pre_doctorant;
...
begin
    ...
    select * into v_pre_etab from pre_etablissement limit 1;
    ...
    --
    -- Création d'un pre_individu : prenom1 = 'PIERRE' donc il n'est pas un doublon du 1er individu ;
...
begin
    ...
    --
    -- Création d'un pre_individu et pre_doctorant associé : ine = 123ABC, code_apprenant_in_source = PEG123
    --
    INSERT INTO pre_individu(id, nom_patronymique, nom_usuel, prenom1, date_naissance, email, source_code, source_id, histo_createur_id, npd_force)
...
begin
    ...
    -- Création de 2 'pre_individu' en doublon.
    INSERT INTO pre_individu(id, nom_patronymique, nom_usuel, prenom1, date_naissance, email, source_code, source_id, histo_createur_id, npd_force)
    select nextval('individu_id_seq'), 'HOCHON', 'test1234', 'PAULE', '2000-01-01', 'aaaa@mail.fr', 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_individu_1;
    INSERT INTO pre_individu(id, nom_patronymique, nom_usuel, prenom1, date_naissance, email, source_code, source_id, histo_createur_id, npd_force)
    ...
    -- Insertion des 2 doublons 'pre_doctorant' associés :
...
begin
    ...
    --
    -- Insertion des 3 doublons 'pre_doctorant' associés :
    --   - ine = 123ABC, code_apprenant_in_source = PEG123
    --   - ine = 123ABC, code_apprenant_in_source = PEG456
    --   - ine = 123ABC, code_apprenant_in_source = PEG456
    --
...
begin
    ...
    --
    -- Historisation d'un pre_doctorant : celui avec code_apprenant_in_source = PEG456
    --   - retrait pre_doctorant de la substitution existante : 2 doublons restants (code_apprenant_in_source = PEG123 car 1er dans alphabet)
    --
...
begin
    ...
    --
    -- Restauration d'un pre_doctorant : celui avec code_apprenant_in_source = PEG456
    --   - ajout pre_doctorant à la substitution existante : 3 doublons (code_apprenant_in_source = PEG456 car majoritaire)
    --
...
begin
    ...
    --   - retrait pre_doctorant de la substitution existante : 2 doublons (code_apprenant_in_source = PEG456 car seule valeur)
    --
...
begin
    ...
    --
    -- Création pre_doctorant avec ine = 666ABC, code_apprenant_in_source = PEG123
    --
    INSERT INTO pre_individu(id, nom_patronymique, nom_usuel, prenom1, date_naissance, email, source_code, source_id, histo_createur_id, npd_force)
    ...
    INSERT INTO pre_doctorant(id, individu_id, ine, etablissement_id, code_apprenant_in_source, source_code, source_id, histo_createur_id, npd_force)
    select nextval('doctorant_id_seq'), v_pre_individu_5.id, '666ABC', v_pre_etab.id, 'PEG123', 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_doctorant_5;
