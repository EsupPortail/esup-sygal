...
--
alter table etablissement add est_substituant bool default false not null;
comment on column etablissement.est_substituant is 'Indique s''il s''agit d''un enregistrement substituant d''autres enregistrements';
alter table etablissement add est_substituant_modifiable bool default true not null;
...
alter table pre_etablissement alter column id set default nextval('etablissement_id_seq'); -- NB : utilisation de la sequence de la table finale
