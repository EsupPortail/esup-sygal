...
--
alter table unite_rech add est_substituant bool default false not null;
comment on column unite_rech.est_substituant is 'Indique s''il s''agit d''un enregistrement substituant d''autres enregistrements';
alter table unite_rech add est_substituant_modifiable bool default true not null;
...
alter table pre_unite_rech alter column id set default nextval('unite_rech_id_seq'); -- NB : utilisation de la sequence de la table finale
