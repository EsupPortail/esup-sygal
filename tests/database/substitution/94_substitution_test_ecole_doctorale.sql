...
begin
    ...
    select nextval('pre_structure_id_seq'), 2, 'ETABLE_HISMAN', 'Etable Hisman', 'test1234', 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    ...
    select nextval('pre_ecole_doct_id_seq'), v_pre_structure_1.id, 'azerty.org', 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    ...
    --
    INSERT INTO pre_structure(id, type_structure_id, code, libelle, sigle, source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_structure_id_seq'), 2, 'ETABLE_HISMAN', 'Etable Hissman', 'test1234', 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_structure_2;

    INSERT INTO pre_ecole_doct(id, structure_id, theme, source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_ecole_doct_id_seq'), v_pre_structure_2.id, 'azerty.fr', 'UCN::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    ...
    INSERT INTO pre_ecole_doct(id, structure_id, theme, source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_ecole_doct_id_seq'), v_pre_structure_3.id, 'azerty.com', 'UCN::'||trunc(10000000000*random()), v_source_id, v_app_user, null
...
begin
    ...
    INSERT INTO pre_ecole_doct(id, structure_id, /*theme,*/ source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_ecole_doct_id_seq'), v_pre_structure_1.id, /*'azerty.de',*/ 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_ecole_doct_1;
    ...
    INSERT INTO pre_ecole_doct(id, structure_id, /*theme,*/ source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_ecole_doct_id_seq'), v_pre_structure_2.id, /*'azerty.al',*/ 'UCN::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_ecole_doct_2;
...
begin
    ...
    INSERT INTO pre_ecole_doct(id, structure_id, /*theme,*/ source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_ecole_doct_id_seq'), v_pre_structure_3.id, /*'azerty.al',*/ 'UCN::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_ecole_doct_3;
...
begin
    ...
    INSERT INTO pre_ecole_doct(id, structure_id, /*theme,*/ source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_ecole_doct_id_seq'), v_pre_structure_1.id, /*'azerty.al',*/ 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_ecole_doct_1;
    ...
    INSERT INTO pre_ecole_doct(id, structure_id, /*theme,*/ source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_ecole_doct_id_seq'), v_pre_structure_3.id, /*'azerty.org',*/ 'UCN::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_ecole_doct_3;
...
begin
    ...
    INSERT INTO pre_ecole_doct(id, structure_id, /*theme,*/ source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_ecole_doct_id_seq'), v_pre_structure_1.id, /*'azerty.com',*/ 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_ecole_doct_1;
    ...
    --
    INSERT INTO pre_structure(id, type_structure_id, code, libelle, sigle, source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_structure_id_seq'), 2, 'PAS_ETABLE_HISMAN', 'Pas Etable Hisman', 'test1234', 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_structure_4; -- NB : pas de NPD forcé donc la structure n'est pas en doublon

    INSERT INTO pre_ecole_doct(id, structure_id, /*theme,*/ source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_ecole_doct_id_seq'), v_pre_structure_4.id, /*'azerty.al',*/ 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, v_npd_ecole_doct_a
...
begin
    ...
    --
    INSERT INTO pre_structure(id, type_structure_id, code, libelle, sigle, source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_structure_id_seq'), 2, 'PAS_ETABLE_HISMAN', 'Etable Hisman', 'test1234', 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_structure_3;

    INSERT INTO pre_ecole_doct(id, structure_id, /*theme,*/ source_code, source_id, histo_createur_id, npd_force)
    select nextval('pre_ecole_doct_id_seq'), v_pre_structure_3.id, /*'azerty.al',*/ 'INSA::'||trunc(10000000000*random()), v_source_id, v_app_user, null
    returning * into v_pre_ecole_doct_3;
