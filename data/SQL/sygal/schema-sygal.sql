...
(
  ...
  STRUCTURE_ID NUMBER not null constraint ETAB_STRUCT_FK references STRUCTURE,
  HISTO_CREATION DATE default sysdate  not null,
  HISTO_MODIFICATION DATE default SYSDATE  not null,
  HISTO_DESTRUCTION DATE,
  HISTO_CREATEUR_ID NUMBER constraint ETAB_UTIL_CREATEUR_FK references UTILISATEUR,
  HISTO_MODIFICATEUR_ID NUMBER constraint ETAB_UTIL_MODIFICATEUR_FK references UTILISATEUR,
  HISTO_DESTRUCTEUR_ID NUMBER constraint ETAB_UTIL_DESTRUCTEUR_FK references UTILISATEUR
);
...
CREATE UNIQUE INDEX OTH.ETABLISSEMENT_DOMAINE_uindex ON ETABLISSEMENT(DOMAINE);
