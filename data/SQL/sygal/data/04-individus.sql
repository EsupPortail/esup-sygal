...
-- Pour pouvoir nous attribuer le rôle ADMIN_TECH :
...
insert into INDIVIDU(
  ...
  select
    ...
    'GAUTHIER',
    'Bertrand',
    'bertrand.gauthier@unicaen.fr',
    'Française',
    (select id from source where code = 'SYGAL::sygal'),
    'UCN::00021237',
    1,
    1
  from dual
...
insert into INDIVIDU(
  ...
  select
    ...
    'METIVIER',
    'Jean-Philippe',
    'jean-philippe.metivier@unicaen.fr',
    'Française',
    (select id from source where code = 'SYGAL::sygal'),
    'UCN::00017566',
    1,
