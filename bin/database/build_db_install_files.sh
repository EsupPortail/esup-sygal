...
PATTERN='categorie_privilege|domaine_scientifique|import_observ|information_langue|nature_fichier|privilege|profil|profil_privilege|soutenance_configuration|soutenance_etat|soutenance_qualite|type_structure|type_validation|version_fichier|wf_etape'
